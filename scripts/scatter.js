function scatter(dIn, day) {
    ...
    var margin = {top: 20, right: 10, bottom: 75, left: 70},
        ...
        height = (innerHeight - margin.top - margin.bottom)*0.6;
    ...
    var c = d3.scaleLinear()
        ...
        //x.domain(["Not at all important", "Not very important", "Somewhat important", "Important", "Very important"]);
    ...
    vis3.append("text")             
        ...
        .text("Value of Formal Education"); 
}